...
namespace Drupal\boundarycommission_breadcrumbs;
 ...
 * {@inheritdoc}
 */
class ConsultationResponseBreadcrumb implements BreadcrumbBuilderInterface {
  ...
  public function applies(RouteMatchInterface $route_match) {
    ...
    if ($route_name == 'entity.node.canonical') {
      ...
      if (!empty($this->node)) {
        if ($this->node->bundle() == 'consultation_response') {
          $match = TRUE;
        }
      }
    }
